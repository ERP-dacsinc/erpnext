...
class BuyingController(SubcontractingController):
	...
	def set_total_in_words(self):
		...
		if self.meta.get_field("base_in_words"):
			if self.meta.get_field("base_rounded_total") and not self.is_rounded_total_disabled() and self.base_rounded_total is not None:
		...
		if self.meta.get_field("in_words"):
			if self.meta.get_field("rounded_total") and not self.is_rounded_total_disabled() and self.rounded_total is not None:
